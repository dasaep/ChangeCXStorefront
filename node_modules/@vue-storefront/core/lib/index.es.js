...
var nuxtContextFactory = function (_a) {
    ...
    var extendContext = function (props) {
        ...
        if (nuxtCtx.$vsf[integrationKey].api) {
            ...
            nuxtCtx.$vsf[integrationKey].api = __assign(__assign({}, current.api), applyContextForApi((props.api || {}), { client: client, config: config }));
        }
        Object.keys(props)
...
var integrationPluginFactory = function (createApiClientFn) { return function (pluginFn) { return function (nuxtCtx, inject) {
    var _a = nuxtContextFactory({ tag: createApiClientFn.tag, nuxtCtx: nuxtCtx, inject: inject }), extendContext = _a.extendContext, injectInContext = _a.injectInContext;
    var configure = function (givenSettings, customApi) {
        if (customApi === void 0) { customApi = {}; }
        var _a = createApiClientFn(givenSettings, customApi), api = _a.api, client = _a.client, settings = _a.settings;
        var props = { api: api, client: client, config: settings };
...
var useCartFactory = function (factoryParams) {
    return function useCart() {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, factoryParams.addItem(context, {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, factoryParams.removeItem(context, {
                                    currentCart: cart.value,
                                    product: product,
                                    customQuery: customQuery
                                })];
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, factoryParams.updateItemQty(context, {
                                    currentCart: cart.value,
                                    product: product,
                                    quantity: quantity,
                                    customQuery: customQuery
        ...
        var load = function (_a) {
            var customQuery = (_a === void 0 ? { customQuery: undefined } : _a).customQuery;
            return __awaiter(_this, void 0, void 0, function () {
                var _b, err_4;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            error.value.load = null;
                            _b = cart;
                            return [4 /*yield*/, factoryParams.load(context, { customQuery: customQuery })];
                        case 2:
                            _b.value = _c.sent();
                            return [3 /*break*/, 5];
                        case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, factoryParams.clear(context, { currentCart: cart.value })];
                    case 2:
                        updatedCart = _a.sent();
                        cart.value = updatedCart;
                        return [3 /*break*/, 5];
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, factoryParams.applyCoupon(context, {
                                    currentCart: cart.value,
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, factoryParams.removeCoupon(context, {
                                    currentCart: cart.value,
                                    coupon: coupon,
                                    customQuery: customQuery
                                })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        loading.value = true;
                        error.value.clear = null;
                        return [4 /*yield*/, factoryParams.clear(context, {
                                currentWishlist: wishlist.value
                            })];
                    case 2:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = categories;
                        return [4 /*yield*/, factoryParams.categorySearch(context, searchParams)];
                    case 2:
                        _a.value = _b.sent();
                        return [3 /*break*/, 5];
                    case 3:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        error.value.search = null;
                        _a = products;
                        return [4 /*yield*/, factoryParams.productsSearch(context, searchParams)];
                    case 2:
                        _a.value = _b.sent();
                        return [3 /*break*/, 5];
                    case 3:
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            _b = user;
                            return [4 /*yield*/, factoryParams.updateUser(context, { currentUser: user.value, updatedUserData: providedUser })];
                        case 2:
                            _b.value = _c.sent();
                            return [3 /*break*/, 5];
                        case 3:
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            _b = user;
                            return [4 /*yield*/, factoryParams.register(context, providedUser)];
                        case 2:
                            _b.value = _c.sent();
                            return [3 /*break*/, 5];
                        case 3:
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            _b = user;
                            return [4 /*yield*/, factoryParams.logIn(context, providedUser)];
                        case 2:
                            _b.value = _c.sent();
                            return [3 /*break*/, 5];
                        case 3:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, factoryParams.logOut(context)];
                    case 2:
                        _a.sent();
                        user.value = null;
                        return [3 /*break*/, 4];
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = user;
                        return [4 /*yield*/, factoryParams.changePassword(context, {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        error.value.load = null;
                        _a = user;
                        return [4 /*yield*/, factoryParams.load(context)];
                    case 2:
                        _a.value = _b.sent();
                        return [3 /*break*/, 5];
                    case 3:
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            _b = shipping;
                            return [4 /*yield*/, factoryParams.addAddress(context, {
                                    address: address,
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            _b = shipping;
                            return [4 /*yield*/, factoryParams.deleteAddress(context, {
                                    address: address,
                                    shipping: readonlyShipping
                                })];
                        case 2:
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            _b = shipping;
                            return [4 /*yield*/, factoryParams.updateAddress(context, {
                                    address: address,
                                    shipping: readonlyShipping
                                })];
                        case 2:
                ...
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        ...
                        case 1:
                            ...
                            _b = shipping;
                            return [4 /*yield*/, factoryParams.setDefaultAddress(context, {
                                    address: address,
                                    shipping: readonlyShipping
                                })];
                        case 2:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        error.value.search = null;
                        _a = orders;
                        return [4 /*yield*/, factoryParams.searchOrders(context, searchParams)];
                    case 2:
                        _a.value = _b.sent();
                        return [3 /*break*/, 5];
                    case 3:
...
function apiClientFactory(factoryParams) {
    var createApiClient = function (config, customApi) {
        if (customApi === void 0) { customApi = {}; }
        var settings = factoryParams.onSetup ? merge(config, factoryParams.onSetup(config)) : { config: config, client: config.client };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        error.value.search = null;
                        _a = reviews;
                        return [4 /*yield*/, factoryParams.searchReviews(context, searchParams)];
                    case 2:
                        _a.value = _b.sent();
                        return [3 /*break*/, 5];
                    case 3:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = reviews;
                        return [4 /*yield*/, factoryParams.addReview(context, params)];
                    case 2:
                        _a.value = _b.sent();
                        return [3 /*break*/, 5];
                    case 3:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        error.value.search = null;
                        _a = result.value;
                        return [4 /*yield*/, factoryParams.search(context, result.value)];
                    case 2:
                        _a.data = _b.sent();
                        return [3 /*break*/, 5];
                    case 3:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        error.value.search = null;
                        _a = content;
                        return [4 /*yield*/, factoryParams.search(context, params)];
                    case 2:
                        _a.value = _b.sent();
                        return [3 /*break*/, 5];
                    case 3:
...
export { AgnosticOrderStatus, Logger, apiClientFactory, configureContext, configureSSR, generateContext, integrationPluginFactory, mask, onSSR, registerLogger, renderContentFactory, sharedRef, track, useCartFactory, useCategoryFactory, useContentFactory, useFacetFactory, useProductFactory, useReviewFactory, useUserBillingFactory, useUserFactory, useUserOrdersFactory, useUserShippingFactory, useVSFContext, useWishlistFactory, vsfRef, wrap };
